                          ...
                          Container(
                            ...
                            child: Stack(children: [
                              Container(
                                  ...
                                  height: height * 0.8),
                              Positioned(
                                  top: ResponsiveWidget.isDesktop(context)
                                      ? height * 0.2
                                      : ResponsiveWidget.isTablet(context)
                                          ? height * 0.42
                                          : ResponsiveWidget.isMobileLarge(
                                      ...
                                      : ResponsiveWidget.isTablet(context)
                                          ...
                                          : ResponsiveWidget.isMobileLarge(
                                              ...
                                              : ResponsiveWidget.isMobile(
                                                  ...
                                                  : width * 0.27,
                                  child: Container(
                                    child: Image.asset(AssetsConstants.myimg),
                                  ))
                            ]),
                          )
                        ],
                                            ...
                                            : ResponsiveWidget.isTablet(context)
                                                ...
                                                : ResponsiveWidget
                                                    ...
                                                    : ResponsiveWidget.isMobile(
                                                        ...
                                                        ? width * 0.05
                                                        : width * 0.02,
                                        letterSpacing: ResponsiveWidget
                                                .isDesktop(context)
                                            ? width * 0.04
                                            : ResponsiveWidget.isTablet(context)
                                                ? width * 0.003
                                ...
                                child: ExpansionTile(
                                  ...
                                  title: Row(children: [
                                    Container(
                                        width: width * 0.7,
                                        child:
                                            Image.asset(AssetsConstants.cnd)),
                                    // Column(
                                    //   crossAxisAlignment:
                                    //       CrossAxisAlignment.start,
                                    //   children: [
